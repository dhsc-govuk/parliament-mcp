...
from parliament_mcp.bedrock_helpers import embed_batch, get_bedrock_client
...
class QdrantDataLoader:
    ...
    def __init__(
        ...
        self.embeddings_client = get_bedrock_client(self.settings)
    ...
    async def store_in_qdrant_batch(self, documents: list[QdrantDocument]) -> None:
        ...
        embedded_chunks = await embed_batch(client=self.embeddings_client, texts=chunk_texts)
