...
from parliament_mcp.bedrock_helpers import embed_single
...
class QdrantQueryHandler:
    def __init__(
        self, qdrant_client: AsyncQdrantClient, embeddings_client: BedrockEmbeddings, settings: ParliamentMCPSettings
    ):
    ...
    async def embed_query_dense(self, query: str) -> list[float]:
        ...
        return await embed_single(self.embeddings_client, query)
