...
class QdrantQueryHandler:
    def __init__(
        self, qdrant_client: AsyncQdrantClient, embeddings_provider: EmbeddingsProvider, settings: ParliamentMCPSettings
    ):
    ...
    async def embed_query_dense(self, query: str) -> list[float]:
        ...
        return await self.embeddings_provider.embed_single(query)
